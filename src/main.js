...
const expirationDataMasked = IMask(expirationData, expirationDatePattern)
...
expirationDataMasked.on("accept", () => {
  updadateExpirationDate(expirationDataMasked.value)
})

function updadateExpirationDate(date){
